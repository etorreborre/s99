...
class MultiwayTreesSpec extends MultiwayTreesProblems { def is =
  """
   ...
   *Count the nodes of a multiway tree*
   ...
   Write a method nodeCount which counts the nodes of a given multiway tree"""                                          ! P70C^
  """
   ...
   *Determine the internal path length of a tree*
   ...
   Write a method internalPathLength to return that sum"""                                                              ! P71^
  """
   ...
   *Lisp-like tree representation*
   ...
   [Note: Much of this problem is taken from the wording of the same problem in the Prolog set. This is certainly one
    ...
    elaborate more on this, if requested"""                                                                             ! P73^
                                                                                                                        end
